...
// private final EphemeralKeyPublic[] ephemeralKeys; // Only public parts (and
// proofs)
// private final ECPoint secret;

// public DistributionInput(DhKeyPair dealerKeyPair, EphemeralKeyPublic[]
// ephemeralKeys, ECPoint secret) {
...
// /**
// * Returns the array of ephemeral key objects. Use getPublicKey() to access
// each
// * ECPoint.
// */
